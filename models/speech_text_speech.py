...
def listen_command_offline_vosk(model_path="/Users/kt/Desktop/Hackathon/humor_io/bf-hackathon/models/vosk-model-small-en-us-0.15"):
    q = queue.Queue()
...
def robot_pipeline(input_mode="text", offline=False):
    if input_mode == "text":
...
# Example usage:
#robot_pipeline("speech", offline=True)   # offline speech
#robot_pipeline("speech", offline=False)  # online speech
#robot_pipeline("text")                   # typed input
