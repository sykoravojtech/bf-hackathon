...
class WaypointNavigator(Node):
    def __init__(self):
        ...
        self.status_sub = self.create_subscription(GoalStatusArray, '/move_base/status', self.status_callback, 10)
    ...
    def send_goal(self, x, y, theta):
        ...
        goal.pose.orientation.z = theta  # Assuming theta is in quaternion form or needs conversion
